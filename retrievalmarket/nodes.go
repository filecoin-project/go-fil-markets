...
type RetrievalProviderNode interface {
	...
	SavePaymentVoucher(ctx context.Context, paymentChannel address.Address, voucher *paych.SignedVoucher, expectedAmount abi.TokenAmount, tok shared.TipSetToken) (abi.TokenAmount, error)
}
