...
func TestClient_Construction(t *testing.T) {
	...
	_, err := retrievalimpl.NewClient(net, t.TempDir(), dt, testnodes.NewTestRetrievalClientNode(testnodes.TestRetrievalClientNodeParams{}), &tut.TestPeerResolver{}, ds)
...
func TestClient_Query(t *testing.T) {
	...
	t.Run("it works", func(t *testing.T) {
		...
		c, err := retrievalimpl.NewClient(net, carPath, dt, node, &tut.TestPeerResolver{}, ds)
		require.NoError(t, err)
...
func TestClient_FindProviders(t *testing.T) {
	...
	t.Run("when providers are found, returns providers", func(t *testing.T) {
		...
		c, err := retrievalimpl.NewClient(net, carPath, dt, &testnodes.TestRetrievalClientNode{}, &testResolver, ds)
		require.NoError(t, err)
...
func TestClient_DuplicateRetrieve(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// Create the client
			client, err := retrievalimpl.NewClient(net, carPath, dt, node, &tut.TestPeerResolver{}, ds)
			require.NoError(t, err)
...
func TestMigrations(t *testing.T) {
	...
	retrievalClient, err := retrievalimpl.NewClient(net, carPath, dt, testnodes.NewTestRetrievalClientNode(testnodes.TestRetrievalClientNodeParams{}), &tut.TestPeerResolver{}, retrievalDs)
	require.NoError(t, err)
