...
// assertQueryReceived performs the verification that a SignedQueryRequest is received
...
// assertQueryResponseReceived performs the verification that a SignedQueryResponse is received
