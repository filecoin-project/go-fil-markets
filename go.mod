...
require (
	github.com/filecoin-project/dagstore v0.4.4-0.20211110134120-3b2ba428bb0f
	...
	github.com/filecoin-project/indexer-reference-provider v0.0.0-20211110094541-0e6c82d9daf6
