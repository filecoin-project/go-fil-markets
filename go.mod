...
require (
	...
	github.com/filecoin-project/go-data-transfer v0.6.7-0.20200929095758-d6c2eaff0694
	github.com/filecoin-project/go-ds-versioning v0.0.0-20200929105738-88a63f46943e
