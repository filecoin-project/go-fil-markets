...
replace github.com/ipld/go-car => github.com/ipld/go-car v0.1.1-0.20201119040415-11b6074b6d4d

replace github.com/ipld/go-car/v2 => /Users/aarshshah/go/src/github.com/ipld/go-car/v2
