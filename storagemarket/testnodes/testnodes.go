...
func (n *FakeCommonNode) OnDealSectorCommitted(ctx context.Context, provider address.Address, dealID abi.DealID, proposalCid cid.Cid, publishCid *cid.Cid, cb storagemarket.DealSectorCommittedCallback) error {
