...
type NewDataTransfer func(ds datastore.Batching, dataTransferNetwork network2.DataTransferNetwork, transport datatransfer.Transport) (datatransfer.Manager, error)

func defaultNewDataTransfer(ds datastore.Batching, transferNetwork network2.DataTransferNetwork, transport datatransfer.Transport) (datatransfer.Manager, error) {
...
func (gen *DepGenerator) New(
	...
	dt1, err := gen.ClientNewDataTransfer(td.DTStore1, td.DTNet1, dtTransport1)
	require.NoError(t, err)
	...
	dt2, err := gen.ProviderNewDataTransfer(td.DTStore2, td.DTNet2, dtTransport2)
	require.NoError(t, err)
