...
func NewClient(
	...
	err = dataTransfer.RegisterVoucherType((*requestvalidation.StorageDataTransferVoucher)(nil).Type(), requestvalidation.NewUnifiedRequestValidator(nil, &clientPullDeals{c}))
	if err != nil {
		return nil, err
	}

	err = dataTransfer.RegisterTransportConfigurer((*requestvalidation.StorageDataTransferVoucher)(nil).Type(), dtutils.TransportConfigurer(&clientStoreGetter{c}))
	if err != nil {
		return nil, err
	}
