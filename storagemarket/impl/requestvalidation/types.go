...
var (
	...
	DataTransferStates = []storagemarket.StorageDealStatus{storagemarket.StorageDealWaitingForResponse, storagemarket.StorageDealValidating, storagemarket.StorageDealUnknown}
)
