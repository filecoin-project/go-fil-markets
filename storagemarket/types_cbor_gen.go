...
func (t *OldClientDeal) MarshalCBOR(w io.Writer) error {
	if t == nil {
...
func (t *OldClientDeal) UnmarshalCBOR(r io.Reader) error {
	*t = OldClientDeal{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("OldClientDeal: map struct too large (%d)", extra)
	}
