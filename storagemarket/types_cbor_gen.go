...
func (t *ClientDeal) MarshalCBOR(w io.Writer) error {
	...
	// t.LastResponse (storagemarket.SignedResponse) (struct)
	if err := t.LastResponse.MarshalCBOR(w); err != nil {
		return err
	}
	return nil
}
...
func (t *ClientDeal) UnmarshalCBOR(r io.Reader) error {
...

	{
		...
		if pb == cbg.CborNull[0] {
			...
			t.LastResponse = new(SignedResponse)
			if err := t.LastResponse.UnmarshalCBOR(br); err != nil {
				return xerrors.Errorf("unmarshaling t.LastResponse pointer: %w", err)
			}
		}
...
func (t *ProposalRequest) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *ProposalRequest) UnmarshalCBOR(r io.Reader) error {
	br := cbg.GetPeeker(r)
...
func (t *ProposalResponse) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *ProposalResponse) UnmarshalCBOR(r io.Reader) error {
	br := cbg.GetPeeker(r)
...
func (t *SignedResponse) MarshalCBOR(w io.Writer) error {
	...
	// t.Response (storagemarket.ProposalResponse) (struct)
